...
import {getBudgetData, addPurchase, removePurchase} from '../../redux/budgetReducer';
...
export default connect(mapStateToProps, {requestUserData, getBudgetData, addPurchase, removePurchase})(Budget);
